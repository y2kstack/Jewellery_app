...
import com.tutorialsee.AddCart;
import com.tutorialsee.BaseActivity;
import com.tutorialsee.Constant;
import com.tutorialsee.ItemDetails;
import com.tutorialsee.MainActivity;
import com.tutorialsee.MyProgressDialog;
import com.tutorialsee.Network;
import com.tutorialsee.PrefernceSettings;
...
public class CartItemAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView,
		...
		// holder.tvCartItemQuantity = (TextView)
		// itemView.findViewById(R.id.txt_ruffpddde);
		...
		Picasso.with(context).load("http://homemonkey.com/timthumb.php?src="+ cartItem.getProduct().getThumb_Images().replace(" ", "%20") + "&w=80&h=110").placeholder(R.drawable.dummy).into(holder.tvCartItemUnitPrice);
	...
	class Cartcheck extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... params) {
			...
			String UERRR = Constant.REG + abc + "&pid=" + pidtest + ""
	...
	class Cartcheckadd extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... params) {
			...
			if (!title.contains("GV")) {
				UERRR = Constant.REG + abc + "&pid=" + pidtest + "" + "&qty="
