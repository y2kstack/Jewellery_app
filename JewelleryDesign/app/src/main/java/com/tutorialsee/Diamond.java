...
public class Diamond extends  Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        JewelleryModelArrayList.add(new JewelleryModel("DSA", R.drawable.n1,"lorem ipsium"));
        JewelleryModelArrayList.add(new JewelleryModel("JAVA", R.drawable.n2 ,"lorem ipsium"));
        JewelleryModelArrayList.add(new JewelleryModel("C++", R.drawable.n3,"lorem ipsium"));
        JewelleryModelArrayList.add(new JewelleryModel("Python", R.drawable.n4,"lorem ipsium"));
        JewelleryModelArrayList.add(new JewelleryModel("Javascript", R.drawable.n5,"lorem ipsium"));
        JewelleryModelArrayList.add(new JewelleryModel("DSA", R.drawable.n6,"lorem ipsium"));
        JewelleryModelArrayList.add(new JewelleryModel("DSA", R.drawable.n1,"lorem ipsium"));
        JewelleryModelArrayList.add(new JewelleryModel("JAVA", R.drawable.n2 ,"lorem ipsium"));
        JewelleryModelArrayList.add(new JewelleryModel("C++", R.drawable.n3,"lorem ipsium"));
        JewelleryModelArrayList.add(new JewelleryModel("Python", R.drawable.n4,"lorem ipsium"));
